...
const Sidebar = () => {
  ...
  // Définir la couleur du sidebar en fonction du rôle
  const getSidebarColor = (role) => {
    switch (role.toLowerCase()) {
      case "student":
        return "#f7f4cd"; // Jaune moutarde pour les étudiants (basé sur la première image)
      case "teacher":
        return "#9dcbea"; // Bleu ciel vif pour les enseignants (basé sur la deuxième image)
      case "admin":
        return "#e6e6ff"; // Bleu clair pour les administrateurs
      default:
  ...
  return (
    <div
      ...
      id="sidebar-wrapper"
      style={{ backgroundColor: getSidebarColor(role) }}
    >
      <div>
        <SidebarIcon />
