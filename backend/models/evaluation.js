...
const evaluationSchema = new mongoose.Schema({
  ...
  engagement: { type: String, enum: ["Très impliqué", "Moyennement impliqué", "Peu impliqué", "Pas du tout impliqué"], required: true },
  ...
  reactionCorrection: { type: String, enum: ["Accepte bien", "Résiste légèrement", "Résiste fortement"], required: true },
